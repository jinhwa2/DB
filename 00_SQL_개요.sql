...
-- 기존에는 계정을 생성하기 위해 ALTER 이용해서
--SCRIPT TURE로 변경해주었지만 이제는 하지 않아도 됨
/*
...
작성방법
INSERT INTO 테이블명(컬럼명1,컬럼명2,컴럼명3,...)VALUES (컴펌에해당하는 값1, 
컬럼에해당하는값2,
컬럼에해당하는값3,...);                                                                                                                                                                                                                                                                                                                   
*/
...
INSERT INTO MEMBER (M_ID, M_NAME,M_AGE,M_PHONE,M_DATE)VALUES (2,'박지훈', '35','1234567890','2024-05-02');
...
VALUES (5,'최민수', '37','1234567894','2024-05-05');
-- 6번 정수진 33 1234567895 2024-05-06
INSERT INTO MEMBER (M_ID, M_NAME,M_AGE,M_PHONE,M_DATE)
VALUES (6,'정수진', '37','1234567895','2024-05-06');
