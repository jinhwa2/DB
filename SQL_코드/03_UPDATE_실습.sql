...
--특정입사일(2000-01-01)이후 특정 입사일 이후 입사한 직원의 급여 수정
UPDATE EMPLOYEE2
...
--LIKE ->무조건 맨 앞이 010이어야하고 중간에 오는 010은 안됨
update employee2
set phone = replace(phone, '010', '010-')
where phone like '010%';
/*
EMPLOYEE2"."PHONE" (actual: 13, maximum: 12)
-->행 최대 크기 12자리로 설정해줬기 떄문에 나중에 발생하는 에러
행 쵀대 크기를 늘리거나 다시 돌아가기 ROLLBACK설정
*/
ROLLBACK;
SELECT * FROM EMPLOYEE2;
