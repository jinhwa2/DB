...
--공채 채용 후 기수별 남아있는 사원수 조회할 때 사용

/*HAVING 실습*/
--1.각 부서별 평균 급여가 400만원 이상인 부서조회
SELECT DEPT_CODE,AVG(SALARY) AS "평균급여"
FROM EMPLOYEE
GROUP BY DEPT_CODE
HAVING AVG(SALARY) > = 40000000;
//적어야하는 것 있음
...
*/
--5.EMPLOYEE 테이블에서
--부서별 70년대생의 급여평균이 300만 이상인 부서를 조회하고
--부서코드 오름차순 정렬
...
/*
D1 D5 D6 70년 대 생들의 평균 급여가 300이상인 부서
D1	3220000
D5	3500000
D6	3900000
*/
