...
--ANSI
SELECT  EMP_NAME, DEPT_TILTE, SALARY
FROM EMPLOYEE
...
FROM EMPLOYEE
JOIN SAL_GRADE ON (EMPLOYEE.SAL_LEVEL = SSAL_GRADE.SAL_LEVEL);
/*
...
*/
--ORACLE
SELECT E.EMPL_NAME, D.DEPT_TITLE,J.JOB_NAME
...
SELECT E.EMAIL, E.DEPT_TITLE
FROM EMPLOYEE E, DEPARTMENT D
WHERE E.DEPT_CODE = D.DEPT_ID;

-- 2.급여가 300만원 이상인 직원들과 이름과 그 직원이 속한 부서명 조회
--TABLE : EMPLOYEE, DEPARTMENT
-- SELECT EMP_NAME,DEPT_TITLE
-- WHERE
...
--3. 각 직원의 이름과 그 직원이 속한 부서명의 부서명, 급영 등급명 조회
...
--2.각 부서의 부서명과 해당 부서에 속한 직원의 평균 급여
