/*지금부터 만드는 것은 KH_WOUKBOOK 이라는 곳에 만들 테이블 생성*/

CREATE TABLE COMPONY (
COMPANY_ID NUMBER PRIMARY KEY,
COMPANY_NAME VARCHAR2(100) NOT NULL,
COMPANY_ADDERESS VARCHAR2(55),
...
-- INSERT COMPANY 회사추가
INSERT INTO COMPANY
VALUES  (COMPANY_SEQ.NEXTVAL,'햇에제과','서울시 강남구','02-1234-4567');
...
INSERT INTO SNACKS
VALUES(SNACKS_SEQ.NEXTVAL,'배배로',1110,2);
