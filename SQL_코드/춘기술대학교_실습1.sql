...
--3.국문학교에 다니는 여학생 중에 휴학중인 여학생 조회
...
--춘 기술대학교 총장의 이름을 알아낼 수 있는 SQL 문장 작성 총장은 NULL
...
FROM TB_CLASS
WHERE PREATTENEING_CLASS_NO IS NOT NULL;

//--8.DISTINCT 활용해서
--춘 대학에는 어떤 카테고리 들이 있는지 조회
SELECT DESTINCT CATEGORY
FROM TB_DEPARTMENT
...
--10.
--춘 대학교 교수 중 이름이 세 글자가 아닌 교수가 두명 있음
--그 교수으 이름과 주민번호 조회
-- FROM TO_PROFESSOR  WHERE LIKE 
...
--14
-- 춘 기술대학교의 2000년 도 이후 입학자들은 학번이 A로 시작하게 되었음
